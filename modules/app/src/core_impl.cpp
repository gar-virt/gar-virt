...
std::expected<gitea::Runner, GenericError> TemplateState::create_runner(const Machine& machine) const {
...
MachinePool TemplateState::create_pool() const {
