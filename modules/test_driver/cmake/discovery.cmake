set(GARVIRT_TEST_DISCOVERY_DIR ${CMAKE_CURRENT_LIST_DIR})

function(garvirt_discover_tests TARGET)
    ...
    set(TEST_DRIVER_INCLUDE_FILE "${GARVIRT_TEST_DISCOVERY_DIR}/discovery.cmake")
    ...
    add_custom_command(
        ...
        COMMAND "${CMAKE_COMMAND}"
            ...
            -P "${GARVIRT_TEST_DISCOVERY_DIR}/generate_includes.cmake"
...
function(garvirt_discover_tests_impl TEST_DRIVER)
    execute_process(
