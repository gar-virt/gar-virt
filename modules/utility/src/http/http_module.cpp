...
export class HttpClient {
    struct Private final {
        Private() : share{curl_share_init()} {
            ...
            constexpr auto lock_fn{
                +[](CURL* /*handle*/, curl_lock_data data, curl_lock_access /*access*/, void* clientp) {
...
public:
    HttpClient(std::string base_url) : m_priv{std::make_unique<Private>()}, m_base_url{std::move(base_url)} {}
